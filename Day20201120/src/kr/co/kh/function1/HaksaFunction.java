...
public class HaksaFunction {
	...
	public  String register(String protocol, BufferedReader input, Statement stmt, Connection conn, int cnt)
	...
	public  void delete(BufferedReader input, Statement stmt, Connection conn, int cnt) throws SQLException, IOException {
	...
	public  void list(Statement stmt, Connection conn) throws SQLException {
			stmt = conn.createStatement();
